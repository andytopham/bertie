...
LOGFILE = '/home/pi/master/log/oled.log'

class Oled:
	'''	Oled class. Routines for driving the serial oled. '''
	def __init__(self, rows = 2):
		self.logger = logging.getLogger(__name__)
		# Important! use /dev/ttyS0 for Pi3 or PiZeroW. Use /dev/ttyAMA0 for all others.
		# or /dev/serial0.
		# also edit /boot/config.txt to append....
		# dtoverlay=pi3-disable-bt
		# this disables bluetooth, so frees up the real serial port.
